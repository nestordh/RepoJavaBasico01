...
public class RespiracionesXMinuto {
    public static void main(String[] args) {
        ...
        final int SEDENTARIO = 1;     //Lo pongo en mayuscula asi se q es una constante
        int MODERADO=2;         //con final signica que ya no le puedo cambiar el valor a la constante
        int ACTIVO = 3;
        ...
        System.out.println("Su rango objetivo de Frecuencia cardiaca es entre " +
                rangoMinimo + " a " + rangoMaximo  + "latido por minuto ");
